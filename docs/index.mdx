...
<section className="w-full">
    ...
    {props.icons.map(icon => (
        <a key={icon.name} href={icon.name} className="relative flex flex-col justify-center p-4 rounded-lg hover:bg-gray-100 cursor-pointer no-underline text-gray-800" data-icon-name={icon.name} data-icon-tags={icon.tags.join(",")}>
            {props.version.split(".").slice(0,2).join(".") === icon.version.split(".").slice(0,2).join(".") && (
