...
<div className="pb-28 pt-16 md:pt-28">
    <div className="flex justify-center w-full mb-4">
        <a className="inline-flex items-center gap-2 rounded-lg bg-gray-100 px-3 py-1 text-sm font-medium no-underline">
            <span className="text-gray-800">Just released <b>v{props.site.version}</b></span>
            <span>🎉</span>
        </a>
    </div>
    <div className="font-black text-6xl sm:text-7xl mb-6 leading-tight tracking-tight text-gray-900 max-w-5xl w-full text-center mx-auto">
    ...
    <div className="flex justify-center w-full">
        <a href={`${props.repository}/releases`} target="_blank" className="flex items-center p-4 rounded-md bg-gray-900 hover:bg-gray-950 text-white cursor-pointer no-underline">
    ...
    <div className="w-full flex flex-col md:flex-row gap-6 flex-nowrap">
        {props.page.data.features.map(feature => (
            <div key={feature.title} className="w-full bg-gray-100 p-8 rounded-md">
                <div className="mb-3 text-5xl text-gray-800">
                    <Icon icon={feature.icon} />
                </div>
                <div className="text-xl font-bold mb-2 text-gray-900">{feature.title}</div>
...
<section className="w-full">
    <div className="mb-6">
        <div className="relative">
            ...
            <input type="text" id="search" className="block bg-white w-full focus:outline-2 focus:outline-gray-500 border border-gray-200 rounded-md pl-10" placeholder="Search for icons..." />
        </div>
    </div>
